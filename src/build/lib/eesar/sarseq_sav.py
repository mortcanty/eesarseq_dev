...
def main():
    ...
    bands 4 through k+3:  bmaps (labeled as end of interval time)  loewner order of changes in each interval (0, 1, 2, 3) byte     
    '''%sys.argv[0]

    options, args = getopt.getopt(sys.argv[1:], 'hc:t:a:p:')
...
#  Juelich AOI    
    ...
    try:    
        ...
        #Run the algorithm ************************************************
        result = change_maps(imList, median = True, alpha = alpha)
        #******************************************************************
